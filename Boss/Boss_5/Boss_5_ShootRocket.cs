...
public class Boss_5_ShootRocket : MonoBehaviour
{
    ...
    public float timeWaitShootRocket;
    ...
    private void FixedUpdate()
    {
        ...
        {
            Destroy(GetComponent<Boss_5_ShootRocket>());
        }
    }
    ...
    {
        yield return new WaitForSeconds(timeWaitShootRocket);
        while (true)
        {
            Vector3 Dir = Player.transform.position - transform.position;
